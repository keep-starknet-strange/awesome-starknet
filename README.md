...
- [starknet-scaffold](https://github.com/tarrencev/starknet-scaffold) - Cairo development scaffold using nile and pytest.
...
- [starknet-devnet](https://github.com/Shard-Labs/starknet-devnet) - Local testnet.
